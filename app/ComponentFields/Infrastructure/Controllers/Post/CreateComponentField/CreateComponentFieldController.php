...
namespace App\ComponentFields\Infrastructure\Controllers\Post\CreateComponentField;
...
final readonly class CreateComponentFieldController
{
    ...
    public function __invoke(CreateComponentFieldRequest $request): JsonResponse
    {
        try {
        ...
        return $this->apiController->sendCreated(message: 'ComponentField was successfully created.');
    }
}
