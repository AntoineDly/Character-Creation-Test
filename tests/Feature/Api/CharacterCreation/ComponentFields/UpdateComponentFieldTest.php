...
it('update partially componentFields should return 201 with componentFields updated partially', function () {
    ...
    $componentFieldExpectedResult = [...$componentFieldNewData, 'user_id' => $this->getUserId()];
    ...
    $response->assertStatus(200)
        ...
        ->assertJson([
            'success' => true,
            'message' => 'Component Field was successfully updated partially.',
        ]);
...
it('update componentFields should return 201 with componentFields updated', function () {
    ...
    $response->assertStatus(200)
        ...
        ->assertJson([
            'success' => true,
            'message' => 'Component Field was successfully updated.',
        ]);
