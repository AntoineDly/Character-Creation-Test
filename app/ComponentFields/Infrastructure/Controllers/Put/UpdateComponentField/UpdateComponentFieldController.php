...
namespace App\ComponentFields\Infrastructure\Controllers\Put\UpdateComponentField;
...
final readonly class UpdateComponentFieldController
{
    ...
    public function __invoke(UpdateComponentFieldRequest $request, string $id): JsonResponse
    {
        try {
